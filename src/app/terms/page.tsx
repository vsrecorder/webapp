    ...
    <div className="flex flex-col">
      ...
      <div className="max-w-3xl mx-auto w-full px-4 pt-8 pb-12 flex flex-col gap-4">
        <p className="text-sm text-neutral-500 dark:text-neutral-400 leading-relaxed px-1">
          ...
          本サービスの利用者の皆さま（以下「ユーザ」といいます。）には、本規約に従って、本サービスをご利用いただきます。
        </p>
        ...
        <div className="rounded-2xl bg-white dark:bg-neutral-900 border border-neutral-100 dark:border-neutral-800 shadow-sm overflow-hidden">
          <Article no="第1条" title="適用">
            <p>
              本規約は、ユーザと運営者との間の本サービスの利用に関わる一切の関係に適用されるものとします。
          ...
          <Article no="第3条" title="認証情報の管理">
            <p>
              ユーザは、自己の責任において、本サービスの認証情報（パスワード等を含みます。）を適切に管理するものとします。
          ...
          <Article no="第6条" title="本サービスの提供の停止等">
            <p className="mb-2">
              運営者は、以下のいずれかの事由があると判断した場合、ユーザに事前に通知することなく、
          ...
          <Article no="第7条" title="著作権">
            <p>
              ユーザは、自ら必要な知的財産権を有するか、権利者の許諾を得た情報のみ投稿できます。
              投稿コンテンツの著作権はユーザまたは既存の権利者に留保されます。
          ...
          <Article no="第8条" title="利用制限および登録抹消">
            <p className="mb-2">
              ユーザが以下に該当する場合、運営者は事前通知なく利用制限または登録抹消を行うことができます。
            </p>
            <ul className="list-disc pl-5 space-y-1">
              <li>本規約違反</li>
          ...
          <Article no="第9条" title="退会">
            <p>ユーザは、運営者の定める手続きにより退会できます。</p>
          </Article>

          <Article no="第10条" title="保証の否認および免責事項">
            <p>
              運営者は、本サービスに瑕疵がないことを保証しません。
              法令上ユーザに対して負う責任を除き、本サービスに起因する損害について責任を負いません。
          ...
          <Article no="第12条" title="利用規約の変更">
            <p>
              運営者は、必要と判断した場合には、ユーザへの通知またはウェブサイト上での告知をもって本規約を変更することができます。
              ユーザに不利益となる変更を行う場合には、事前に相当な期間をもってお知らせします。
          ...
          <Article no="第14条" title="通知または連絡">
            <p>
              ユーザと運営者との間の通知は、運営者の定める方法により行います。
          ...
          <Article no="第15条" title="権利義務の譲渡の禁止">
            <p>
              ユーザは、運営者の事前承諾なく、利用契約上の地位または権利義務を第三者に譲渡できません。
            </p>
          </Article>
