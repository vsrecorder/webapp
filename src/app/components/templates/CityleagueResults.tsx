    ...
    <>
      ...
      <div className="pt-12 w-full">
        <Tabs
          ...
          /*
            上端をヘッダーの下端(--header-height)に合わせ、タブ自体は pt-1 で元の 60px に置く。
            ...
            lg はタブがヘッダー下端にぴったり付くので、pt は 0 に戻す。
          */
          className="fixed z-50 top-[var(--header-height)] left-0 right-0 pt-1 lg:pt-0 pl-1 pr-1 app-dot-bg-plain"
          classNames={{
            cursor: "",
            tab: "h-8",
            tabList: "",
